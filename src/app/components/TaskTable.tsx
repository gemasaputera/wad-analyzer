  ...
  return (
    <div className="space-y-6">
      <div className="bg-white p-4 rounded-lg shadow">
        <h2 className="text-xl text-black font-semibold mb-2">Analysis Summary</h2>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <p className="text-sm text-gray-600">Total Time Spent</p>
            <p className="text-lg font-medium text-black">{analysis.totalTimeSpent} hours</p>
          </div>
          <div>
      ...
      <div className="space-y-4">
        {analysis.dailyTasks.map((day, dayIndex) => {
          const dailyTotal = day.tasks.reduce((sum, task) => sum + task.timeSpent, 0);
          return (
            <motion.div
              key={day.day}
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    ...
                    <tr className="bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">Total Time Spent</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">{dailyTotal}</td>
